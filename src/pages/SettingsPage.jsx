  ...
  return (
    <div className="settings">
      <header className="settings-header">
        ...
        <h1 className="back-text">Setting</h1>
      </header>
      ...
      <div className="settings-content">
        ...
        <div className="settings-list">
          <div className="settings-item">Tell Friends</div>
          <div className="settings-item">Rate and Review</div>
          <div className="settings-item">Privacy</div>
          <div className="settings-item">More apps</div>
        </div>
      </div>
    </div>
  )
