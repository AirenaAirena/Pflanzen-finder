...
export default function ResultPage() {
  ...
  const plantImage = result?.images?.[0]?.url
  ...
  return (
    <div className="result-page">
      <div className="result-image">
        ...
        <button onClick={() => navigate(-1)} className="result-back-btn">
          <svg
            width="30"
            height="23"
            viewBox="0 0 30 23"
      ...
      <div className="result-info">
        ...
        <div className="result-taxonomy">
          <div className="result-taxonomy-item">
            <label>Genus</label>
            <span>{suggestion?.plant_details?.taxonomy?.genus}</span>
          </div>
          <div className="result-taxonomy-item">
            <label>Family</label>
            <span>{suggestion?.plant_details?.taxonomy?.family}</span>
          </div>
        </div>

        <p className="result-description-label">Description</p>
